# Agent Operating Instructions for ignorelens

This file defines how AI agents and human maintainers should work in `ignorelens`.

## Project Context

- Project: `ignorelens`
- Repository: `https://github.com/rogerchappel/ignorelens`
