...
Replace this section with the supported versions for `ignorelens`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `ignorelens` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ignorelens.
